...
Recipe.create!([
  {name: "Bacon Grilled Cheese Sandwich",
   ...
   pictures: ["http://cdn1.bostonmagazine.com/wp-content/uploads/2015/04/GrilledCheese2015_Coda.jpg"]
 },
  {name: "Pad See Ew",
    ...
    pictures: ["https://s-media-cache-ak0.pinimg.com/564x/db/ff/70/dbff70a63e29557a8599b15ff116a0bf.jpg"]
  },
    ...
    {name: "Bacon Alfredo Fettuccine",
      ...
      pictures: ["http://img.sndimg.com/food/image/upload/w_555,h_416,c_fit,fl_progressive,q_95/v1/img/recipes/47/18/14/piclU9zcA.jpg"]
    }
